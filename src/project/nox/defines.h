...
#define CLINE_SIZE_BYTES (COMPRESS_NOX ? (((tr->noxlinesize*SET_SEG_SIZE)) ? ((tr->noxlinesize*SET_SEG_SIZE)) : 1) :\
                     (((tr->linesize*SET_SEG_SIZE)) ? ((tr->linesize*SET_SEG_SIZE)) : 1) )
