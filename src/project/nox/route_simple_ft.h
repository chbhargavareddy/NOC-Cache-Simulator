...
/* 
 * Simple fault-tolerant routing algorithm
 */

#ifndef _simple_ft_router_h
#define _simple_ft_router_h

#include "router.h"

void dest_in_straight_ft(int dir, int cn, int pc, int vc, int dx, int dy, int *dest_pc, int *dest_vc, int *is_blocked, int *nbuf);
void dest_in_diagonal_ft(int dir1, int dir2, int cn, int pc, int vc, int dx, int dy, int *dest_pc, int *dest_vc, int *is_blocked, int *nbuf);
